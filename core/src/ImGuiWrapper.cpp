...
void ImGuiWrapper::Construct(VkRenderPass renderpass) {
    ...
    if (!callbacks_registered) {
        RenderingContext::RegisterScrollCallback(ScrollCallback);
        RenderingContext::RegisterCharCallback(CharCallback);
        RenderingContext::RegisterMouseButtonCallback(MouseButtonCallback);
        RenderingContext::RegisterKeyboardKeyCallback(KeyCallback);

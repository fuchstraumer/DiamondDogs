...
vulpes::PlanarMesh::PlanarMesh(const double& side_length, const size_t& subdivision_level, const glm::vec3& pos, const glm::vec3& scale, const glm::vec3& angle) : Mesh(pos, scale, angle), SubdivisionLevel(subdivision_level), SideLength(side_length) {}

vulpes::PlanarMesh& vulpes::PlanarMesh::operator=(PlanarMesh && other){
...
void vulpes::PlanarMesh::Generate() {

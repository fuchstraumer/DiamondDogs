...
namespace vulpes {
	namespace terrain {
		...
		size_t HeightNode::RootMeshGridSize = 32;
		double HeightNode::RootNodeLength = 1000;

		HeightNode::HeightNode(const glm::ivec3 & node_grid_coordinates, std::vector<HeightSample>& init_samples) : gridCoords(node_grid_coordinates), sampleGridSize(RootMeshGridSize + 5), meshGridSize(RootMeshGridSize) {

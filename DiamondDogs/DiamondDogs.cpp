...
int buildmap()
{
	...
	const double CONTINENT_FREQUENCY = 1.7;
	...
	const double MOUNTAINS_AMOUNT = 0.4;
	...
	const double BADLANDS_AMOUNT = 0.045;
	...
	const double TERRAIN_OFFSET = 1.2;
	...
	module::Simplex baseContinentDef_pe0;
	...
	module::Simplex baseContinentDef_pe1;
	...
	module::Simplex badlandsCliffs_pe;
	...
	module::Simplex scaledMountainousTerrain_pe;
	...
	module::Simplex scaledHillyTerrain_pe;
	...
	module::Simplex continentsWithBadlands_pe;

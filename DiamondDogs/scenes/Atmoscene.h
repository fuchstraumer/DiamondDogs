#pragma once
#ifndef VULPES_ATMOSPHERE_SCENE_H
#define VULPES_ATMOSPHERE_SCENE_H
...
namespace atmo_scene {
	...
	class AtmoScene : public BaseScene {
	public:
		...
		AtmoScene() : BaseScene() {
			...
			const std::type_info& id = typeid(AtmoScene);
			...
			instance->SetCamPos(glm::vec3(10000.0f, 0.0f, 0.0f));

			object = new Atmosphere(device, 12000.0f, instance->GetProjectionMatrix());
...
#endif // !VULPES_ATMOSPHERE_SCENE_H
